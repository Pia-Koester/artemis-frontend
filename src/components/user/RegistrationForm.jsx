...
export default function RegistrationForm({ trial, activity, id }) {
  ...
  const formSubmit = (data) => {
    ...
    const formData = trial ? { ...data, trial } : data;
    console.log("Data from form", formData);
    const endpoint = id ? `activities/${id}/trial` : "signup"; // Determine the endpoint based on the presence of id
    axiosClient
  ...
  return (
    <>
      <ul className="steps steps-horizontal my-5">
        ...
        <li
          className={clsx("step", (step === 2 || step === 3) && "step-primary")}
        >
      ...
      {step === 1 ? (
        ...
        >
          <div className="login-info ">
            <div className="label self-start">
              <span className="label-text">Gib deine E-Mail Adresse an</span>
            </div>
            <input
              placeholder="E-Mail"
            ...
            <div className="flex relative mr-7 items-center ">
              <input
                ...
                {...register("password", {
                  ...
                  minLength: {
                    value: 8,
                    message: "Passwörter müssen mindestens 8 Zeichen lang sein",
                  },
                })}
              />
            </div>
        ...
        >
          <label>
            ...
            <div className="personal-details">
              ...
              <div className="label self-start">
                <span className="label-text">Wie ist deine Telefonnummer?</span>
              </div>
              <input
                ...
                {...register("phoneNumber", {
                  ...
                  pattern: {
                    value: /^[0-9]*$/,
                    message: "Deine Telefonnummer darf nur aus Zahlen bestehen",
                  },
                })}
              />{" "}
              ...
              <input
                ...
                className="input input-bordered w-full max-w-xs input-primary "
                {...register("street", {
                  required: "Stassenname und Hausnummer sind erforderlich",
                })}
              />{" "}
              ...
              <input
                ...
                {...register("postalCode", {
                  ...
                  pattern: {
                    value: /^[0-9]{5}$/,
                    message: "Deine Postleitzahl darf nur aus Zahlen bestehen",
                  },
                })}
              />{" "}
        ...
        <form onSubmit={handleSubmit(formSubmit)}>
          {" "}
          <div className="label self-start">
            <span className="label-text">Verrate uns dein Geburtsdatum</span>
          </div>
          <input
